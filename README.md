...
- 3 push buttons + 10kΩ resistors
- 3.5mm audio jack or USB audio adapter
- WiFi connectivity

### GPIO Wiring
```
Button 1 (Describe) → GPIO 17
Button 2 (OCR)      → GPIO 27
Button 3 (Neural)   → GPIO 22
All buttons         → GND (through 10kΩ pull-up resistors)
```
